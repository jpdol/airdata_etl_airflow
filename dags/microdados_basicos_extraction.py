...
def make_request(reference_date: date = date.today()):
    """
    Faz requisição para a API de microdados básicos da ANAC
    ...
    url = f'https://sas.anac.gov.br/datavoo_api/basica?dt_referencia={date_str}'
...
@dag(dag_id='microdados_basicos_extraction', schedule='0 7 * * *', max_active_runs=1)
def microdados_basicos_extraction():
    """
    ...
    create_table = SQLExecuteQueryOperator(
        ...
        CREATE TABLE IF NOT EXISTS airdata.microdados_basicos (
            ...
            sg_equipamento_icao TEXT,          -- código ICAO do equipamento
            ds_matricula TEXT,                 -- matrícula da aeronave
            ...
            lt_combustivel REAL,               -- litros de combustível
            nr_assentos_ofertados INTEGER,     -- número de assentos ofertados
            kg_payload REAL,                   -- payload em kg
            km_distancia REAL,                 -- distância em km
            ...
            nr_horas_voadas REAL,              -- número de horas voadas
            kg_peso REAL,                      -- peso em kg
        ...
        while current_date <= end_date:
            ...
            try:
                ...
                numeric_columns = [
                    ...
                    'kg_carga_paga', 'kg_carga_gratis', 'kg_correio', 'nr_decolagem',
                    'nr_horas_voadas', 'kg_peso', 'nr_ask', 'nr_rpk', 'nr_atk', 'nr_rtk', 'nr_etapa'
                ]
